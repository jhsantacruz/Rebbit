...
public class RebbitMainActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    protected DialogInterface.OnClickListener mDialogListener = new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            switch(i){
                case 0: //Take picture
                    ...
                    mMediaUri = getOutputMediaFIelUri(MEDIA_TYPE_IMAGE);
                    if(mMediaUri == null){
                        Toast.makeText(RebbitMainActivity.this, R.string.error_external_storage,
                ...
                case 1: // Take video
                    ...
                    mMediaUri = getOutputMediaFIelUri(MEDIA_TYPE_VIDEO);
                    if(mMediaUri == null){
                        Toast.makeText(RebbitMainActivity.this, R.string.error_external_storage,
                                Toast.LENGTH_LONG).show();
                    } else {
        ...
        private Uri getOutputMediaFIelUri(int mediaTypeImage) {
            if(isExternalStorageAvailable()){
                // get the URI

                // 1) Get the external storage directory
                String appName = RebbitMainActivity.this.getString(R.string.app_name);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.rebbit_main, menu);
        return true;
    }
